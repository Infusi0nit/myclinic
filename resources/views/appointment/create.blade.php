            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form enctype="multipart/form-data" method="post" action="{{route('appointment.store')}}" class="form-horizontal">
                ...
                if(res){
                    ...
                    $.each(res,function(key,value){
                        ...
                        if((value.middle_name)!=null){
                            $("#doctor_id").append('<option value="'+value.id+'">'+value.title+' ' +value.first_name+'' +ISNULL((value.middle_name + '. '), ' ')+'  '+value.last_name+'</option>');
                        }else{
                            $("#doctor_id").append('<option value="'+value.id+'">'+value.title+' ' +value.first_name+'  '+value.last_name+'</option>');
                        }
